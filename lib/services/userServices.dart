  ...
  Future<int> createUser(UserModel newUser) async {
    try {
      ...
      if (statusCode == 201) {
        ...
        return 201; // Usuario creado exitosamente
      } else if (statusCode == 400) {
        print('Error: ${response.data["error"]}');
        return 400; // Error como email en uso
      } else {
        print(
            'Error desconocido al crear usuario. Código de estado: $statusCode');
        return -1;
      }
    } on DioError catch (e) {
      if (e.response != null) {
      ...
      return -1; // Otro error inesperado
    }
  }
